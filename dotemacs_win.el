...
(define-key omakey-map "c"    '(lambda() (interactive) (oma-shell-exec-string "python tour.py\r")))
(define-key omakey-map "\C-c" '(lambda() (interactive) (save-buffer) (shell-command "cd /mnt/c/prj/PythonTour; python3 tour.py")))
...
(defun oma-shell-exec-string (arg)
  ...
  (let (curbuf (current-buffer))
    (switch-to-buffer "1")
    (end-of-buffer)
    ;;(execute-kbd-macro "cd /mnt/c/prj/PythonTour; python3 tour.py\r")
    (execute-kbd-macro arg)
